        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={5}>
            <Box sx={{ position: 'relative' }}>
              <Image src="/images/home-feature-new1.png" width={650} height={678} quality={97} alt="Feature img" />
              <Box
              // sx={{
              //   position: 'absolute',
              //   top: -36,
              ...
              >
                ...
                >
                  <Typography sx={{ fontWeight: 600, lineHeight: 1 }}>Layanan CS</Typography>
          ...
          <Grid item xs={12} md={7}>
            ...
            <Typography sx={{ color: 'text.secondary', mb: 2, ml: { xs: 0, md: 4 } }}>
              Berikut kelebihan dari layanan kami.
            </Typography>
